...
export const AuthProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const login = async (email: string, password: string) => {
    ...
    try {
      ...
      setError({ message: error instanceof Error ? error.message : "Login failed. Please try again." });
      throw error;
    } finally {
      setIsLoading(false);
    }
  ...
  const register = async (name: string, email: string, password: string) => {
    ...
    try {
      ...
      setError({ message: error instanceof Error ? error.message : "Registration failed. Please try again." });
      throw error;
    } finally {
      setIsLoading(false);
    }
